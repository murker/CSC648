<div class="container">
    <div>
        ...
        <?php echo htmlspecialchars($invoice->customer_id, ENT_QUOTES, 'UTF-8'); ?>
        <label>Cart_id: </label>
        <?php echo htmlspecialchars($invoice->cart_id, ENT_QUOTES, 'UTF-8'); ?>
        <label>Total: </label>
        <?php echo htmlspecialchars($invoice->total, ENT_QUOTES, 'UTF-8'); ?>
        <label>Shipping cost: </label>
        <?php echo htmlspecialchars($invoice->order_date, ENT_QUOTES, 'UTF-8'); ?>
        <label>Shipping cost: </label>
        <?php echo htmlspecialchars($invoice->shipping_cost, ENT_QUOTES, 'UTF-8'); ?>
        <label>Tax: </label>
        <?php echo htmlspecialchars($invoice->tax, ENT_QUOTES, 'UTF-8'); ?>
        <label>Total: </label>
        <?php echo htmlspecialchars($invoice->grand_total, ENT_QUOTES, 'UTF-8'); ?>
    </div>
</div>
