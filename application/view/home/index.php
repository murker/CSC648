...
<?php foreach ($products as $product) { ?>
                    <div class="col-sm-4 col-lg-4 col-md-4">
                        <div class="thumbnail">
                          <?php if (isset($product->img1)) echo '<img src="data:image/jpeg;base64,'.base64_encode($product->img1).'"  height="320" width="150" />';
                          else
                              echo '<img src="http://placehold.it/320x150">'; ?>
                            <div class="caption">
                                <h4 class="pull-right"><?php if (isset($product->price)) echo "$" . htmlspecialchars($product->price, ENT_QUOTES, 'UTF-8'); ?></h4>
                                <h4><a href="#"><?php if (isset($product->name))
