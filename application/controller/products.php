...
class Products extends Controller
{
    ...
    public function addProduct()
    {
        ...
        if (isset($_POST["submit_add_product"])) {
            ...
            $this->model->addProduct($_POST["name"], $_POST["description"], $_POST["price"], $_POST["stock_qty"], $_POST["category_id"]);
        }
    ...
    public function updateProduct()
    {
        ...
        if (isset($_POST["submit_update_product"])) {
            ...
            $this->model->updateProduct($_POST["name"], $_POST["description"], $_POST["price"], $_POST["stock_qty"], $_POST["category_id"], $_POST["product_id"]);
        }
